...
public class TSAGeoMag
{
    ...
    private static Logger logger = Logger.getLogger(TSAGeoMag.class.getName());
	...
	try{
	    ...
	    InputStream input = this.getClass().getResourceAsStream("WMM.COF");
	    if(input == null) {
			System.out.println("WMM.COF not found");
			throw new FileNotFoundException("WMM.COF not found");
		}else {
	    	System.out.println("WMM.COF found");
		}
	    ...
	    logger.log(Level.INFO,"TSAGeoMag Epoch is: " + epoch);
	    logger.fine("TSAGeoMag default date is: " + defaultDate);
	    str.nextToken();
	    //strModel = str.sval;
	    str.nextToken();
