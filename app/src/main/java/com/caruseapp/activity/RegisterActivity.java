 ...
 */
public class RegisterActivity extends BaseAcitvity {
    ...
    public void init() {
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                OkHttpUtil.getInstance(getBaseContext()).requestAsyn("users/register", TYPE__REGISTER, params, header,new OkHttpUtil.ReqCallBack<String>() {
                    @Override
